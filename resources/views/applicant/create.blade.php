            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ '/applicant/create' }}"  enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('resume') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="resume" type="file" class="form-control" name="resume" value="{{ old('resume') }}">
                            ...
                            {{--                                <div class="col-md-6">--}}
                            {{--                                    <input id="role" type="radio" class="form-control" name="role" value=0>Company<br>--}}

                            {{--                                    <input id ="role" type="radio" class="form-control" name="role" value="0">Applicant<br>--}}
                            {{--                                    @if ($errors->has('role'))--}}
                            {{--                                        <span class="help-block">--}}
