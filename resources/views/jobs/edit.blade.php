                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="PUT" action="{{ '/jobs/'.$job->id.'/edit' }}">
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="description" type="text" class="form-control" name="description" value="{{ $job->description }}">
                            ...
                            <div class="form-group{{ $errors->has('salary') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="salary" type="text" class="form-control" name="salary" value="{{ $job->salary }}">
                            ...
                            <div class="form-group{{ $errors->has('work_exp') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="work_exp" type="text" class="form-control" name="work_exp" value="{{ $job->work_exp }}">
